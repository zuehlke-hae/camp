...
gradle --info createProject -PDEBUG -PDIR=$WORKDIR -PPACKAGE=zuehlke.food -PNAME=androidfxclient -PANDROID_SDK=$ANDROID_SDK -PJFX_SDK=$OPENJFX_DIR -PJFX_APP=$PROJECT_DIR -PJFX_MAIN=zuehlke.food.HelloWorld
